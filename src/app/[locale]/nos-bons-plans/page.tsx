      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-5 py-2 text-sm font-medium text-[--color-chocolat] shadow-sm mb-6">
            ...
            15 offres exclusives
          </div>
          <h1 className="text-display text-[--color-chocolat] mb-5 leading-[1.1]">
            Nos{" "}
            <span style={{ color: "#E8705A" }}>bons plans</span>
          </h1>
          <p className="text-lead">
            Des offres exclusives chez nos partenaires triés sur le volet — alimentation premium, soins, accessoires, assurance et compléments pour le bien-être de votre animal.
          </p>
        </div>
      </section>

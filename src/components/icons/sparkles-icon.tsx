...
const SparklesIcon = forwardRef<SparklesIconHandle, SparklesIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, color = "currentColor", strokeWidth = 2, ...props }, ref) => {
    ...
    useImperativeHandle(ref, () => {
      ...
      return {
        startAnimation: () => { sparkleControls.start("hover"); starControls.start("blink", { delay: 1 }); },
        stopAnimation: () => { sparkleControls.start("initial"); starControls.start("initial"); },
      };
    });
    ...
    const handleMouseEnter = useCallback(
      (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        else { sparkleControls.start("hover"); starControls.start("blink", { delay: 1 }); }
      },
    ...
    const handleMouseLeave = useCallback(
      (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        else { sparkleControls.start("initial"); starControls.start("initial"); }
      },

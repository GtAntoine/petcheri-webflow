...
const PawPrintIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  ({ size = 24, color = "currentColor", strokeWidth = 2, className = "" }, ref) => {
    ...
    const start = useCallback(async () => {
      ...
      await animate(".paw-inner", { y: 0, opacity: 1, scale: 1 }, { duration: 0.15, ease: [0.33, 1, 0.68, 1] as [number, number, number, number] });
      await animate(".paw-inner", { scale: [1, 0.75, 1.1, 1], y: [0, -1, 0] }, { duration: 0.3, ease: "easeInOut" });
    ...
    return (
      ...
      >
        <motion.g className="paw-inner" style={{ transformOrigin: "center" }}>
          ...
          <path d="M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.84 1.045Q6.52 17.48 4.46 16.84A3.5 3.5 0 0 1 5.5 10Z" stroke={color} strokeWidth={strokeWidth} />
        </motion.g>
      </motion.svg>
    );
  },

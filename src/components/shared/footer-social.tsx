    ...
    <div className="flex gap-3">
      {SOCIALS.map(({ label, href, Icon }, i) => (
        <a
          ...
          aria-label={label}
          className="w-11 h-11 rounded-full border border-[--color-ivoire]/20 flex items-center justify-center text-[--color-ivoire]/60 hover:border-[--color-or] hover:text-[--color-or] transition-colors"

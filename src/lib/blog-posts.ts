...
<p>Contactez immédiatement le centre antipoison vétérinaire (France : 04 78 87 10 40) ou votre vétérinaire d'astreinte. N'induisez jamais le vomissement sans avis professionnel.</p>`,
  ...
  // ─── Comparatif ──────────────────────────────────────────────────────────────
  {
    id: "comparatif-plateformes-garde-animaux-france",
    slug: "comparatif-plateformes-garde-animaux-france-2026",
    title: "Garde d'animaux en France : comparatif complet des meilleures plateformes (2026)",
    excerpt: "Rover, Animaute, Holidog, Pawshake, Petcheri… Comment choisir la bonne plateforme de garde pour votre chien, chat ou NAC ? On compare les services, les garanties et les prix.",
    author: "Anne",
    date: "2026-06-01",
    category: "Guide",
    tags: ["comparatif", "garde animaux", "rover", "holidog", "petsitter", "plateforme", "chien", "chat"],
